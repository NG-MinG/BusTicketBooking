            ...
            <table className={styles["seat-table"]}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "A05" isChoosing = {props.choosingSeats.includes("A05")} onChooseSeat = {props.onChooseSeat} /></td>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "A08" isChoosing = {props.choosingSeats.includes("A08")} onChooseSeat = {props.onChooseSeat}/></td>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "A11" isChoosing = {props.choosingSeats.includes("A11")} onChooseSeat = {props.onChooseSeat}/></td>
                    ...
                    <tr>
                        <td><Seat color = "#737B83" seatID = "A16" isChoosing = {props.choosingSeats.includes("A16")} onChooseSeat = {props.onChooseSeat}/></td>
                        <td><Seat color = "red" seatID = "A17" isChoosing = {props.choosingSeats.includes("A17")} onChooseSeat = {props.onChooseSeat}/></td>
                        <td><Seat color = "#737B83" seatID = "A18" isChoosing = {props.choosingSeats.includes("A18")} onChooseSeat = {props.onChooseSeat}/></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <table className={styles["seat-table"]}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "B05" isChoosing = {props.choosingSeats.includes("B05")} onChooseSeat = {props.onChooseSeat}/></td>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "B08" isChoosing = {props.choosingSeats.includes("B08")} onChooseSeat = {props.onChooseSeat}/></td>
                    ...
                    <tr>
                        ...
                        <td><Seat color = "red" seatID = "B11" isChoosing = {props.choosingSeats.includes("B11")} onChooseSeat = {props.onChooseSeat}/></td>
                    ...
                    <tr>
                        <td><Seat color = "#737B83" seatID = "B16" isChoosing = {props.choosingSeats.includes("B16")} onChooseSeat = {props.onChooseSeat}/></td>
                        <td><Seat color = "red" seatID = "B17" isChoosing = {props.choosingSeats.includes("B17")} onChooseSeat = {props.onChooseSeat}/></td>
                        <td><Seat color = "#737B83" seatID = "B18" isChoosing = {props.choosingSeats.includes("B18")} onChooseSeat = {props.onChooseSeat}/></td>
                    </tr>
                </tbody>
            </table>
        </div>
